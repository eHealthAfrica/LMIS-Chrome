...
angular.module('lmisChromeApp')
  .controller('MainCtrl', function($scope, storageService) {
    // TODO: uncomment this to clear local storage and load new fixture any time
    //      you update fixture then comment back
      ...
      if (Object.keys($scope.program_product).length > 0) {
        storageService.insert(storageService.PROGRAM_PRODUCTS, $scope.program_product)
          .then(function() {
            ...
            if($scope.uuid) {
              msg.message = 'Program update was successful';
            } else {
              msg.message = 'Program entry was successful';
            }
