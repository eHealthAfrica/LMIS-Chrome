...
angular.module('lmisChromeApp')
    .config(function($stateProvider) {
      $stateProvider
          ...
          .state('stockCountStepForm', {
            ...
            url:'stockCountStepForm?facility&report_month&report_year',
   ...
   */
    .controller('StockCountCtrl', function($scope, $stateParams, stockCountFactory, currentFacility) {
      ...
      $scope.step = 0;
      $scope.maxStep =  $scope.stock_products.length>0?$scope.stock_products.length - 1: 0;
      ...
      $scope.report_month = ($stateParams.report_month !== null)?$stateParams.report_month:month;
   ...
   */
    ...
    .controller('StockCountStepsFormCtrl', function($scope){
      $scope.preview = false;
